                                        ...
                                        <div className="luachonphuongthucthanhtoan">
                                            ...
                                            <div role="tabpanel main-tabs">
                                                ...
                                                <ul className="nav" role="" id="payTypeSl">
                                                    <li style={{ width: "100%", padding: "20px" }} className="active text-center">
                                                        <label>
                                                            <input type="radio" name="site_name" value={"Thanh toán khi nhận hàng"} defaultChecked={true}/>
                                                ...
                                                <div className="hidden-md hidden-lg hidden-sm choise-payment">
                                                    <button className="btn text-right">Tiếp tục</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
module.exports = connect(function (state) {
    return {
        stepOrder: state.stepOrder, shoppingCart: state.shoppingCart
    }
})(StepPayment);