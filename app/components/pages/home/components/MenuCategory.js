         ...
         return(
            ...
            <ul>
                    ...
                    return(
                        ...
                        <li key={itemindex} >  <a href="#" data-toggle="collapse" data-target={"#"+item.id} data-parent="#sidenav01" className="collapsed"> {item.name} <span className={item.children.length>0?"fa fa-angle-double-down":""}></span>
                        </a>
